package com.kat.guestHouse.controller;
...
@Controller
public class guestHouseMainController {
	...
	@RequestMapping("kat/tourHouse/house.do")
	public ModelAndView guestHouseView(@RequestParam(name="page", defaultValue = "1") int pageNumber,
		@RequestParam(name = "userid", defaultValue = "1") String user_id,Search search, HttpServletRequest request) throws IllegalStateException, IOException {
		...
		modelAndView.setViewName("guestHouse_main");
