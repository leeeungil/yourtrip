...
public class UserReInfo {

	private String shop_id; // 예약한 매장 아이디
	private int file_no; // 예약한 좌석
	...
	public String toString() {
		return "UserReInfo [shop_id=" + shop_id + ", file_no=" + file_no + ", file_seat=" + file_seat
