...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA5s4pJbjRg6BepnRE74YzFPctKGD7yyQo&libraries=places&callback=initAutocomplete" async defer></script>
