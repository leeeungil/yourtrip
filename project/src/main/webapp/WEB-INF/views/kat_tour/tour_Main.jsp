...
<div id="main">
	<section>
		<article id="article_main">
			...
			<div id="ma1" style="margin-top:250px; text-align:center; background-color:#D8D8D8; font-size:30px;">숙박</div>
			<div class="service">
                <div class="sitem1">
                    <img src="<%=request.getContextPath()%>/img/japan-1750129_640.jpg" style="width:310px; height:250px; border-radius:10px;">
                    <div>
                       <br>
                        <p>&nbsp;&nbsp;아시아</p><br>
                    </div>
                ...
                <div class="sitem1">
                     <img src="<%=request.getContextPath()%>/img/paris-843229_640.jpg" style="width:310px; height:250px; border-radius:10px;">
                    <div>
                       <br>
                        <p>&nbsp;&nbsp;유럽</p><br>
                   </div>
                ...
                <div class="sitem1">
                    <img src="<%=request.getContextPath()%>/img/rio-2352566_640.jpg" style="width:310px; height:250px; border-radius:10px;">
                    <div>
                       <br>
                        <p>&nbsp;&nbsp;남미</p><br>
                    </div>
                ...
                <div class="sitem1">
                    <img src="<%=request.getContextPath()%>/img/waters-3151381_640.jpg" style="width:310px; height:250px; border-radius:10px;">
                    <div>
                       <br>
                        <p>&nbsp;&nbsp;북미</p><br>
                    </div>
            ...
            <div id="ma2" style="margin-top:150px; text-align:center; background-color:#D8D8D8; font-size:30px;">셔틀</div>     
			<div class="service2">
                <div class="sitem1">
                    <img src="<%=request.getContextPath()%>/img/temple-2608307_640.jpg" style="width:310px; height:250px; border-radius:10px;">
                    <div>
                       <br>
                        <p>&nbsp;&nbsp;아시아</p><br>
                    </div>
                ...
                <div class="sitem1">
                     <img src="<%=request.getContextPath()%>/img/canal-3047927_640.jpg" style="width:310px; height:250px; border-radius:10px;">
                    <div>
                       <br>
                        <p>&nbsp;&nbsp;유럽</p><br>
                   </div>
                ...
                <div class="sitem1">
                    <img src="<%=request.getContextPath()%>/img/chile-675688_640.jpg" style="width:310px; height:250px; border-radius:10px;">
                    <div>
                       <br>
                        <p>&nbsp;&nbsp;남미</p><br>
                    </div>
                ...
                <div class="sitem1">
                    <img src="<%=request.getContextPath()%>/img/guard-3102533_640.jpg" style="width:310px; height:250px; border-radius:10px;">
                    <div>
                       <br>
                        <p>&nbsp;&nbsp;북미</p><br>
                    </div>
                 ...
                 <div id="ma3" style="margin-top:150px; text-align:center; background-color:#D8D8D8; font-size:30px;">투어</div>     
			...
			<c:if test="${ShopPhotoList.getPhotoInfoList().size() != 0}">
                ...
                <c:forEach var="shop" items="${ShopPhotoList.getPhotoInfoList()}">
                    <img src="<%=request.getContextPath()%>/uploadfile/shopphoto/${shop.file_shopphoto}" style="width:310px; height:250px; border-radius:10px;">
                </c:forEach>   
                 <div>
             </c:if>
                       <br>
                ...
                <div class="sitem1">
                     <img src="<%=request.getContextPath()%>/img/evening-3091998_640.jpg" style="width:310px; height:250px; border-radius:10px;">
                    <div>
                       <br>
                        <p>&nbsp;&nbsp;유럽</p><br>
                   </div>
                ...
                <div class="sitem1">
                    <img src="<%=request.getContextPath()%>/img/people-1284253_640.jpg" style="width:310px; height:250px; border-radius:10px;">
                    <div>
                       <br>
                        <p>&nbsp;&nbsp;남미</p><br>
                    </div>
                ...
                <div class="sitem1">
                    <img src="<%=request.getContextPath()%>/img/mount-rushmore-2268636_640.jpg" style="width:310px; height:250px; border-radius:10px;">
                    <div>
                       <br>
                        <p>&nbsp;&nbsp;북미</p><br>
                    </div>
