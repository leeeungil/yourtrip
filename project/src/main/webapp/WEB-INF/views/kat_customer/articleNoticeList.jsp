...
<div class="totalView">
	<div id="mainSize">
		<img class="megaphone"
			...
			style="height: 40px; width: 40px; position: relative; top: 10px; margin-right: 20px; border: none;"><span
			id="articleNoticeListForm">공지사항</span> <br>
		<table id="articleNoticeListTable">
			...
			<tr>
				<td colspan="4" id="pagecenter"><c:forEach var="i" begin="1"
						end="${ListInfoNotice.getPageNumber()}" step="1">
