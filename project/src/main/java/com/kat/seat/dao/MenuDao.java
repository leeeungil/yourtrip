...
public interface MenuDao {
	...
	public int mainMenuSelectCount(String id);

	public int shopCount2(int pageNumber);

	public List<ShopPhoto> shopPhotoList2(int pageNumber, int firstRow, int totalCount);

	public int menuSelectCount2(int pageNumber);

	public List<MenuInfo> menuList2(int pageNumber, int firstRow, int totalCount);

	public InfoShopAddress getShopAddress2(int pageNumber);
